def cost_manager():
    ...
    car = float(input(f'What the value of {costs_fixed[5]}: '))
    rent = float(input(f'What the value of {costs_fixed[5]}: '))
    gasoline = float(input(f'What the value of {costs_fixed[5]}: '))
